...
The abstract is found in the document Sphinx builds — see :ref:`technote-lint-abstract-scan` for exactly what counts (including abstracts pulled in with ``include`` directives).
